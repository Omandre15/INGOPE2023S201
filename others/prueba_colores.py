...
sg.popup_quick_message('Building your table... one moment please...', background_color='red', text_color='white',
                       font='_ 20')
...
window = sg.Window('Color Viewer',
                   [[sg.Text('Hover mouse to see RGB value, click for popup with buttons', justification='center',
                             font='Default 15')]] +
                   [[sg.Button(color_list[row_num + i * total_rows],
                               button_color=('black', color_list[row_num + i * total_rows]),
                               key=color_list[row_num + i * total_rows],
                               tooltip=color_map[color_list[row_num + i * total_rows]], border_width=0) for i in
                     range(colors_per_row)] for row_num in range(total_rows)], font='Default 7',
...
while True:
    ...
    layout2 = [[sg.DummyButton(event, button_color=('white', event), tooltip=color_map[event]),
